...
import { Brain, Zap, Lock, BarChart3, Sparkles, Globe, GitBranch, Bell } from "lucide-react";
...
const features = [
  {
    ...
    desc: "State-of-the-art models trained on billions of samples.",
    gradient: "gradient-indigo-cyan",
  },
  {
    icon: Zap,
    title: "Real-time API",
    desc: "Sub-second inference with global edge deployment.",
    gradient: "gradient-purple-pink",
  },
  {
    icon: Lock,
    title: "Zero-trust Security",
    desc: "End-to-end encryption, SOC2-aligned processes.",
    gradient: "gradient-blue-purple",
  },
  {
    icon: BarChart3,
    title: "Deep Analytics",
    desc: "Dashboards for accuracy, threats, and inbox health.",
    gradient: "gradient-emerald-cyan",
  },
  {
    icon: Sparkles,
    title: "Explainable AI",
    desc: "See the reasoning behind every prediction.",
    gradient: "gradient-cyan-blue",
  },
  {
    icon: Globe,
    title: "Multi-region",
    desc: "Data residency in US, EU, and APAC on demand.",
    gradient: "gradient-indigo-cyan",
  },
  {
    icon: GitBranch,
    title: "Webhooks",
    desc: "Trigger workflows on any classification event.",
    gradient: "gradient-purple-pink",
  },
  {
    icon: Bell,
    title: "Alerting",
    desc: "Route incidents to Slack, PagerDuty, or email.",
    gradient: "gradient-blue-purple",
  },
];
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            MailSentry ships with the depth of an enterprise product and the ergonomics of a modern
            developer tool.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {features.map((f, i) => (
            ...
            >
              <div>
                <div
                  className={`flex h-11 w-11 items-center justify-center rounded-xl text-white shadow-soft ${f.gradient}`}
                >
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-widest text-brand">Roadmap</p>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div
                key={r.title}
                className="rounded-xl border border-border/50 bg-card/40 p-5 glow-card-hover"
              >
